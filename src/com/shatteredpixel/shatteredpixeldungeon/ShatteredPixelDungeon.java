...
public class ShatteredPixelDungeon extends Game {
	...
	public static void softify( boolean value ) {
		Preferences.INSTANCE.put( Preferences.KEY_SOFTIFY, value );
	}
	
	public static boolean softify() {
		return Preferences.INSTANCE.getBoolean( Preferences.KEY_SOFTIFY, true );
	}
