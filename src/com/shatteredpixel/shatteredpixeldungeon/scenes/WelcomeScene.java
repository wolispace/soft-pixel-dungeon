...
public class WelcomeScene extends PixelScene {
    ...
    private static final String TXT_Welcome =
            "Soft Pixel Dungeon is minor mod that makes Shattered Pixel Dungeon not so hard, with more useful items dropped in grass, a larger searching radius and you can load/save games.\n\n"+    		
