...
public class WndSettings extends Window {
	...
	private static final String TXT_SOFTIFY	= "Not so hard";
	...
	public WndSettings( boolean inGame ) {
		...
		if (!inGame) {
			...
			CheckBox btnSoftify = new CheckBox( TXT_SOFTIFY ) {
				@Override
				protected void onClick() {
					super.onClick();
					ShatteredPixelDungeon.softify(checked());
				}
			};
			btnSoftify.setRect( 0, (btnSound != null ? btnSound.bottom() : BTN_HEIGHT) + GAP, WIDTH, BTN_HEIGHT );
			btnSoftify.checked( ShatteredPixelDungeon.softify() );
			add( btnSoftify );
			...
			btnOrientation.setRect( 0, btnSoftify.bottom() + GAP, WIDTH, BTN_HEIGHT );
			add( btnOrientation );
